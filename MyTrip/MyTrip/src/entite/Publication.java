...
public class Publication {
    ...
    public Publication(int id, String contenuP, Date dateP, Evenement IdEv, Utilisateur IdU) {
        this.id = id;
    ...
    public String toString() {
        return "Publication{" + "id=" + id + ", contenuP=" + contenuP + ", dateP=" + dateP + ", IdEv=" + IdEv + ", IdU=" + IdU + '}';
    }
